    ...
    items: [
      {
        ...
        name: "Filled Donuts",
        prices: ["$1.29 each", "$6.99 - 6 count", "$11.99 - 12 count"],
      },
      {
        image: "glazed_donut.jpeg",
        name: "Glazed Donuts",
        prices: ["$1.19 each", "$6.69 - 6 count", "$10.99 - 12 count"],
      },
      {
      ...
      },
      {
        ...
        name: "Donut Holes",
        prices: ["$1.89 - 6 count", "$2.29 - 12 count"],
      },
      {
    ...
    items: [
      {
        image: "eclair.jpeg",
        name: "Éclair Cake",
        prices: ["$1.89 each", "$10.99 - 6 count", "$16.99 - 12 count"],
      },
      {
    ...
    items: [
      {
        ...
        prices: ["$2.69 each", "$15.99 - 6 count", "$25.99 - 12 count"],
      },
      {
        image: "cream_cheese_danish.jpeg",
        name: "Cream Cheese Danish",
        prices: ["$10.99 - 6 count", "$16.99 - 12 count"],
      },
      {
        image: "blueberry_danish.jpeg",
        name: "Blueberry Danish",
        prices: ["$1.89 each", "$10.99 - 6 count", "$26.99 - 12 count"],
      },
      {
    ...
    items: [
      {
        ...
        name: "Cheese Sausage",
        prices: ["$1.59 each", "$7.99 - 6 count", "$15.99 - 12 count"],
      },
      {
        image: "sausage.jpeg",
        name: "Plain Sausage",
      ...
      },
      {
        ...
        prices: ["$2.99 each", "$16.99 - 6 count", "$27.99 - 12 count"],
      },
      {
        image: "jalapeno.jpeg",
    ...
    items: [
      {
        ...
        prices: ["$1.99 each", "$22.99 - 6 count", "$35.99 - 12 count"],
      },
      {
      ...
      },
      {
        ...
        prices: ["$3.89 each", "$22.99 - 6 count"],
      },
      {
    ...
    items: [
      {
        image: "juice.jpeg",
        name: "Juice",
        prices: ["$2.19 - Small", "$2.79 - Large"],
      },
      {
        image: "soda.jpg",
        name: "Soda",
        prices: ["$1.49 - Small", "$2.49 - Large"],
      },
      {
        image: "milk.jpeg",
        name: "Milk",
        prices: ["$1.79 - Small", "$2.79 - Large"],
      },
      {
        image: "monster.jpg",
